    ...
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        >
          ...
          >
            <a href="#kontakt" onClick={(e) => scrollToSection(e, "kontakt")}>
        ...
        <motion.a
          href="#uber-uns"
          onClick={(e) => scrollToSection(e, "uber-uns")}
          animate={{ y: [0, 8, 0] }}
          transition={{ duration: 1.5, repeat: Infinity }}
          className="absolute bottom-8 rounded-full border border-white/30 p-3 text-white/60 hover:bg-white/10 cursor-pointer transition-colors"
        >
